...
def do_managed_mode():
    ...
    if checkClientMode():
        log.info('123 Entering client managed-mode.')
...
def pyobfsproxy():
    ...
    log.warning('Obfsproxy (version: %shttps://github.com/Yawning/obfsproxy.gitarting up.' % (__version__))
